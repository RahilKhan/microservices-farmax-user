...
<html lang="en">
	...
	<body>
		...
		<div class="text-center">
			...
			<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#fluidModalRightSuccessDemo">Right</button> <br>
			<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#fluidModalLeftInfoDemo">Left</button> <br>
			<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#fluidModalTopWarningDemo">Top</button> <br>
			<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#fluidModalBottomDangerDemo">Bottom</button>
		</div>
